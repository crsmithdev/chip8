...
use ui::sdl2::rect::{Point, Rect};
use ui::sdl2::event::Event;
use ui::sdl2::keyboard::Keycode;
use ui::sdl2::render::{Canvas, Texture, TextureCreator};
use ui::sdl2::video::{Window, WindowContext};
use ui::sdl2::ttf::{Font, Sdl2TtfContext};
...
impl <'a, 'b> System<'a, 'b> {
    ...
    pub fn new(gfx: GfxSubsystem<'a, 'b>, event_pump: sdl2::EventPump) -> System<'a, 'b> {
